...
- If Qwen3-4B-Instruct-2507 misses ≥ 95% slot accuracy, the fallback is Qwen3-8B under the same grammar (~2× VRAM, still fits T4/12 GB), not prompt surgery.
